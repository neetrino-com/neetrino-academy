...
2. **gallery** - Галерея изображений (только изображения, отображается в формате галереи)
3. **file** - Файлы для скачивания (документы, архивы, видео - отображается в формате списка)
4. **video** - Видео с встроенным плеером
5. **code** - Блок кода с подсветкой синтаксиса
6. **link** - Внешняя ссылка
